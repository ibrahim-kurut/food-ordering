...
const Cart = () => {
    ...
    return (
        <div>
            <div className="min-h-[calc(100vh_-_368px)]">
                <div className="flex justify-between items-center md:flex-row flex-col">
                                    ...
                                    <tbody>
                                        <tr className="transition-all bg-secondary border-gray-700 hover:bg-primary capitalize">
                                            <td className="py-4 px-6 font-medium whitespace-nowrap hover:text-white flex items-center gap-x-1 justify-center">
                                                <Image src="/img/pizzaSize.png" alt="" width={50} height={50} />
                                                <span>Good Pizza</span>
                                            </td>
                                            <td className="py-4 px-6 font-medium whitespace-nowrap hover:text-white">
                                                <span>ketchup, mayonnaies, hot sauce</span>
                                            </td>
                                            <td className="py-4 px-6 font-medium whitespace-nowrap hover:text-white">
                                                $20
                                            </td>
                    ...
                    <div className="bg-secondary min-h-[calc(100vh_-_433px)] flex flex-col justify-center text-white p-12 md:w-auto w-full   md:text-start !text-center">
                        ...
                        <div className="mt-4" onClick={() => dispatch(resetCart())}>
                            <Btn btnName="CHECKOUT NOW!" />
                        </div>
                    </div>
                </div>
            </div>
